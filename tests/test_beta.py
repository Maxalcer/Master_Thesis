...
df.to_csv("/home/mi/maxa55/Master_Thesis/Results/Plots/beta.csv", index=False)


plt.figure(figsize=(10, 6))
sns.boxplot(x='Beta', y='Perf', hue='Method', data=df)
plt.title('Performance Comparison by beta')
plt.ylabel('Performance')
plt.xlabel('beta')
plt.legend(title='Method')
plt.tight_layout()
plt.savefig("/home/mi/maxa55/Master_Thesis/Results/Plots/beta.png")
plt.show()