...
class DQN(nn.Module):
    ...
    def __init__(self):
        ...
        #self.fcn_4 = nn.Linear(512, 512)
        #self.fcn_norm_4 = nn.LayerNorm(512)
        #self.fcn_5 = nn.Linear(512, 512)
        #self.fcn_norm_5 = nn.LayerNorm(512)
        #self.fcn_6 = nn.Linear(512, 512)
        #self.fcn_norm_6 = nn.LayerNorm(512)
